...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 04, 2019 at 04:47 PM
...
DELIMITER $$
CREATE TRIGGER `updateBookedRoom` AFTER INSERT ON `hr_bookings` FOR EACH ROW INSERT INTO hr_booked_rooms VALUES (null, NEw.room_id, NEW.checkin_date, NEW.checkout_date,NEW.booked_dates)
$$
DELIMITER ;
